...
if __name__ == '__main__':
    ...
    train_day_interval = extract_day_interval_feature(train_dir + 'train_log.csv')

    train_data = merge_features(agg_feature=train_agg, log=train_log, time_interval=train_time_interval, day=train_day_interval)
    ...
    test_day_interval = extract_day_interval_feature(test_dir + 'test_log.csv')
    test_data = merge_features(agg_feature=test_agg, log=test_log, time_interval=test_time_interval, day=test_day_interval)
    print('load data end')
